...
runners.forEach( function(runners) {
 fullName.push(getFullName(runners))
  })
...
runners.forEach((runners) => ticketPriceTotal.push(runners.donation));
console.log(ticketPriceTotal.reduce( (total, subTotal) => total += subTotal));
